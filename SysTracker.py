...
root = Tk()
root.title('SysTracker')
root.geometry('680x450')
root.resizable(False, False)
root.config(bg='#1d0238')

Label(root, text='SysTracker : System Info Display', font='Arial 20 bold', fg='#f2bc94', bg="#1d0238",pady=30).pack()
TextBox = Text(root, height=15, width=57, font='Verdana 10 bold')
TextBox.place(x = 140, y= 145)
...
def About():
   webbrowser.open('https://www.linkedin.com/in/mainak-chaudhuri-127898176/')
Button(root, text='System Info', bg='#ffee00', fg='#00154f', font='Verdana 10 bold', width=10,relief=RIDGE, command=SystemInfo).place(x=20, y=100)
Button(root, text='Boot Time', bg='#f5a2fc', fg='#00154f', font='Verdana 10 bold', width=10,relief=RIDGE, command=boottime).place(x=170, y=100)
Button(root, text='CPU Info', bg='#f5a2fc', fg='#00154f', font='Verdana 10 bold', width=10,relief=RIDGE, command= CPUInfo).place(x=290, y=100)
Button(root, text='Memory Info', bg='#f5a2fc', fg='#00154f', font='Verdana 10 bold', width=10,relief=RIDGE, command=MemoryInfo).place(x=410, y=100)
Button(root, text='Disk Info', bg='#f5a2fc', fg='#00154f', font='Verdana 10 bold', width=10,relief=RIDGE, command=DiskInfo).place(x=530, y=100)
Button(root, text='Network Info', bg='#ffee00', fg='#00154f', font='Verdana 10 bold', width=10,relief=RIDGE, command = NetworkInfo).place(x=20, y=170)
Button(root, text='GPU Info', bg='#ffee00', fg='#00154f', font='Verdana 10 bold', width=10,relief=RIDGE, command=GPUInfo).place(x=20, y=235)
Button(root, text='About', bg='#ffee00', fg='#00154f', font='Verdana 10 bold', width=10,relief=RIDGE, command=About).place(x=20, y=300)
Button(root, text='Exit', bg='#ffee00', fg='#00154f', font='Verdana 10 bold', width=10,relief=RIDGE, command=exit).place(x=20, y=360)
